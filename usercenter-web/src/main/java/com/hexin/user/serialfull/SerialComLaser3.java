 ...
 * Time: 16:56
 */
public class SerialComLaser3 extends Observable implements Runnable,SerialPortEventListener {
    private static final Logger LOGGER = LoggerFactory.getLogger(SerialComLaser3.class);
