 ...
 * Time: 16:56
 */
public class SerialCom3 extends Observable implements Runnable,SerialPortEventListener {
    private static final Logger LOGGER = LoggerFactory.getLogger(SerialCom3.class);
