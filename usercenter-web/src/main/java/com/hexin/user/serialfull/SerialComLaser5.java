 ...
 * Time: 16:56
 */
public class SerialComLaser5 extends Observable implements Runnable,SerialPortEventListener {
    private static final Logger LOGGER = LoggerFactory.getLogger(SerialComLaser5.class);
        ...
        switch ( event.getEventType() )
        {
            ...
            case SerialPortEvent.DATA_AVAILABLE: // 1
                try
                {
                    ...
                    System.out.println(ByteUtil.BinaryToHexString(readBuffer));
