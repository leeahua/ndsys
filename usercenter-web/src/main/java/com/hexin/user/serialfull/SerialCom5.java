 ...
 * Time: 16:56
 */
public class SerialCom5 extends Observable implements Runnable,SerialPortEventListener {
    private static final Logger LOGGER = LoggerFactory.getLogger(SerialCom5.class);
